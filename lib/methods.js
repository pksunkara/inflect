...
// Returns the name in a greeting format, it change the first letter as a capital letter and abbreviates the second name.

inflect.greetings = function (name) {
  if (!name){
  ...
  return result[0].replace(result[0].substring(0,1), result[0].substring(0,1).toUpperCase()) + " " + result[1].substring(0,1).toUpperCase()
};
