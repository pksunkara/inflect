...
(function() {
  if (typeof module !== 'undefined') {
    module.exports = inflectMethods(require('./util'), require('./inflections'));
  } else if (typeof define === 'function' && define.amd) {
    define(['./util', './inflections'], inflectMethods);
  }

  function inflectMethods(util, inflections) {
    var inflect = {};
    ...
    inflect.camelize = function(lower_case_and_underscored_word, first_letter_in_uppercase) {
      var result;
      if (typeof first_letter_in_uppercase === 'undefined') {
    ...
    inflect.uncountability = function (word) {
      return inflect.inflections.uncountables.some(function(ele) {
